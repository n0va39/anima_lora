...
STRINGS: dict[str, str] = {
    ...
    "dataset_preprocess_clear_tooltip": "清除当前图像的预处理使用/跳过决定。",
    "dataset_preprocess_save": "保存预处理决定",
    "dataset_preprocess_save_tooltip": "将逐图像跳过/裁剪决定保存为预处理使用的 JSON。",
    ...
    "dataset_delete": "移动",
    "dataset_delete_tooltip": "将用 Delete 键标记的图像和 sidecar 移动到 post_image_dataset/moved/。",
    "dataset_delete_clear": "取消",
    "dataset_delete_clear_tooltip": "清除所有移动标记 (Esc 键仅取消当前图像)。",
