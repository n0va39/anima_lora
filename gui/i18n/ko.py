...
STRINGS: dict[str, str] = {
    ...
    "dataset_preprocess_clear_tooltip": "현재 이미지의 전처리 사용/생략 결정을 해제합니다.",
    "dataset_preprocess_save": "전처리 결정 저장",
    "dataset_preprocess_save_tooltip": "전처리에서 사용할 이미지별 생략/크롭 결정을 JSON으로 저장합니다.",
    ...
    "dataset_delete": "이동",
    "dataset_delete_tooltip": "Delete 키로 표시한 이미지를 사이드카와 함께 post_image_dataset/moved/로 이동합니다.",
    "dataset_delete_clear": "취소",
    "dataset_delete_clear_tooltip": "모든 이동 표시를 해제합니다 (Esc 키는 현재 이미지만 해제).",
