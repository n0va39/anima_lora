...
STRINGS: dict[str, str] = {
    ...
    "dataset_delete_clear_tooltip": "Clear the move mark on the current image. Use the right-side menu to clear all move marks.",
    "dataset_delete_clear_all": "Clear all move marks",
