...
STRINGS: dict[str, str] = {
    ...
    "dataset_preprocess_clear_tooltip": "Clear the current image's preprocess use/skip decision.",
    "dataset_preprocess_save": "Save preprocess decisions",
    "dataset_preprocess_save_tooltip": "Save per-image skip/crop decisions as JSON for preprocessing.",
    ...
    "dataset_delete": "Move",
    "dataset_delete_tooltip": "Move the images marked with the Delete key to post_image_dataset/moved/, along with sidecars.",
    "dataset_delete_clear": "Cancel",
    "dataset_delete_clear_tooltip": "Clear all move marks (Esc un-marks just the current image).",
