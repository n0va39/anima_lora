...
STRINGS: dict[str, str] = {
    ...
    "dataset_preprocess_clear_tooltip": "現在の画像の前処理使用/スキップ決定を解除します。",
    "dataset_preprocess_save": "前処理決定を保存",
    "dataset_preprocess_save_tooltip": "前処理用の画像別スキップ/クロップ決定を JSON として保存します。",
    ...
    "dataset_delete": "移動",
    "dataset_delete_tooltip": "Delete キーで印を付けた画像とサイドカーを post_image_dataset/moved/ へ移動します。",
    "dataset_delete_clear": "キャンセル",
    "dataset_delete_clear_tooltip": "すべての移動マークを解除します (Esc キーは現在の画像のみ解除)。",
